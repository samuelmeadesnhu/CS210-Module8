...
// handle input
void inputHandler(int userInput) {
	...
	case 1:
		...
		CallProcedure("printPurchaseList");
		break;
	case 2:
		// Return key for entered value
		cout << "Item lookup: " << endl;
		cin >> key;
		cout << callIntFunc("printValue", key) << endl;
		break;
...
void main()
{
	...
	// Initialize menu validation list
	int userInput = 0;
	set<int> validInput{ 1, 2, 3, 4 };

	while (validInput.count(userInput) == 0) {
		CallProcedure("printMenu");
		cin >> userInput;
		cin.clear();
		cin.ignore(10000, '\n');
		if (userInput == 0) {
			cout << "Error: please enter a numeric value of 1, 2, 3, or 4." << endl;
		}
